...
namespace HTL
{
	...
	public:
		...
		int DebugPrint(int intLevel,char *fmt, ...);
		int DeleteDebugFile();
	...
	protected:
		...
		int DebugPrintToStream(char *fmt, va_list args);
		int DebugPrintToFile(char *fmt, va_list args);
		virtual int DebugPrintToTextEdit(char *fmt, va_list args);
