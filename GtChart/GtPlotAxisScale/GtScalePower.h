...
#ifndef GT_SCALE_POWER_H
#define GT_SCALE_POWER_H
...
namespace GT
{
	namespace GtChart
	{
		...
		class HTL_DLLAPI GtScalePower : public GtScaleBase
		{
		public:
			//!Parent set constructor
			GtScalePower(GtObject* ptrParent = NULL);
			//!Virtual destructor
			virtual ~GtScalePower(void);
