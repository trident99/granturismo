...
#ifndef GT_AXIS_HORIZONTAL_H
#define GT_AXIS_HORIZONTAL_H
...
namespace GT
{
	namespace GtChart
	{
		...
		class HTL_DLLAPI GtAxisHorizontal : public GtPlotItem
		{
		public:
			//!Parent set constructor
			GtAxisHorizontal(GtObject* ptrParent = NULL);
			//!Virtual destructor
			virtual ~GtAxisHorizontal(void);
			...
			GTOBJECT_MEMVAR_BYREF(public, std::string, strLabel);
			//SIGNALS/////////////////////////////////
		public:			
			//MEMBER FUNCTIONS////////////////////////
		public:
