...
namespace GT
{
	namespace GtChart
	{
		...
		GtPlot2DScatter::GtPlot2DScatter(GtObject* ptrParent)
			:GtPlot2DBase(ptrParent)
		{

		};
			//!Virtual destructor
		GtPlot2DScatter::~GtPlot2DScatter(void)
		{
	
		};
		//GTWIDGET INHERITED FUNCTIONS
		//!Custom Event Processing
		int GtPlot2DScatter::HandleEvent(GtEvent * ptrEvent)
		{
			return 0;
		};
		//!Custom Widget Painting
		int GtPlot2DScatter::OnPaint(GtPainter * painter)
		{
			if(!painter){return 0;};
