...
#ifndef GT_PLOT_2DBAR_H
#define GT_PLOT_2DBAR_H
...
namespace GT
{
	namespace GtChart
	{
		...
		class HTL_DLLAPI GtPlot2DPieChart : public GtPlot2DBase
		{
		public:
			//!Parent set constructor
			GtPlot2DPieChart(GtObject* ptrParent = NULL);
			//!Virtual destructor
			virtual ~GtPlot2DPieChart(void);
