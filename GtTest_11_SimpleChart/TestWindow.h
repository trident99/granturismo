...
#include <GtPlot2D\GtPlot2DLegend.h>
#include <GtPlot2D\GtPlot2DCurve.h>
#include <GtPlot2D\GtPlot2DScatter.h>
...
protected:
	...
	GtSimpleTextEdit * m_txtItemName;
	
	GtPlot2DCurve * m_ptrPlot01;
	GtPlotCurve * m_ptrCurve01;
	GtPlotCurve * m_ptrCurve02;
	
	GtPlot2DScatter * m_ptrPlot02;
	GtPlotPointSet* m_ptrSet01;
	GtPlotPointSet* m_ptrSet02;
