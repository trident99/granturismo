...
#ifndef GT_PLOT_2DColumn_H
#define GT_PLOT_2DColumn_H
...
namespace GT
{
	namespace GtChart
	{
		...
		class HTL_DLLAPI GtPlot2DColumn : public GtPlot2DBase
		{
		public:
			//!Parent set constructor
			GtPlot2DColumn(GtObject* ptrParent = NULL);
			//!Virtual destructor
			virtual ~GtPlot2DColumn(void);
