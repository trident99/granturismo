...
#ifndef GT_VERTICAL_SCROLLBAR_H
#define GT_VERTICAL_SCROLLBAR_H
...
namespace GT
{
	namespace GtGui
	{
		...
		class HTL_DLLAPI GtVertScrollBar : public GtSlider
		{
		public:
			//!Parent set constructor
			GtVertScrollBar(GtObject* ptrParent = NULL);
			//!Virtual destructor
			virtual ~GtVertScrollBar(void);
