...
#ifndef GT_PLOT_CURVE_H
#define GT_PLOT_CURVE_H
...
namespace GT
{
	namespace GtChart
	{
		...
		class HTL_DLLAPI  GtPlotCurve: public GtPlotItem
		{
		public:
			//!Parent set constructor
			GtPlotCurve(GtObject* ptrParent = NULL);
			//!Virtual destructor
			virtual ~GtPlotCurve(void);
			//PUBLIC OPERATOR
			//!Assignment Operator
			GtPlotCurve & operator = (GtPlotCurve & rhs);
			//!EQUAL TO Operator
			bool operator == (GtPlotCurve & rhs);
