...
namespace GT
{
	namespace GtCore
	{
		...
		//
		struct HTL_DLLAPI GtWinFont
		{
			GtWinFont()
			{
				memset(this,0,sizeof(GtWinFont));
			}
			~GtWinFont(){};
			...
			int			m_nInternalLeading;
			int			m_nDescent;
		} ;

		struct HTL_DLLAPI GtCanvas
		{
			GtCanvas();
			~GtCanvas();
			//viewport frame
		...
		public:
			...
			//!Destructor
			~GtPainter();
			//!Pen for the painter component
			HTLMEMVAR_BYVAL_STYLE1(public, HDC, ptrHDC);
			//!Pen for the painter component
			HTLMEMVAR_BYVAL_STYLE1(public, HWND, winID);
			//!Pen for the painter component
			HTLMEMVAR_BYREF_STYLE1(public, GtPen, objPen);
			//!Paint Brush for the painter component
			HTLMEMVAR_BYREF_STYLE1(public, GtBrush, objBrush);
			//!Paint Brush for the painter component
			HTLMEMVAR_BYREF_STYLE1(public, GtFont, objFont);
			//!Paint Brush for the painter component
			HTLMEMVAR_BYREF_STYLE1(public, GtRectI, objClipRect);
			//!Paint Brush for the painter component
			HTLMEMVAR_BYREF_STYLE1(public, GtRectI, objViewport);
			//!Paint Brush for the painter component
			HTLMEMVAR_BYREF_STYLE1(public, GtRectI, objWindow);
			//!Paint Brush for the painter component
			HTLMEMVAR_BYREF_STYLE1(public, GtPoint3DI, ptOffset);
		...
		public:
			//DRAWING FUNCTIONS//////////////////////////
			//!Begin a global Painting Session
			virtual bool GtBeginPainting(void);
			//!End a global Painting Session
