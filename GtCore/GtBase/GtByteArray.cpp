...
namespace GT
{
	...
	namespace GtCore
	{
		...
		//ChrNode GtByteArray::m_objSharedNull;
		...
		GtByteArray::GtByteArray(const char * unicode, int size)
			: m_chrNull('\0')
		{
		...
		GtByteArray::GtByteArray(char c)
			: m_chrNull('\0')
		{
			//This constructor takes the incoming text and
			//appends it to the current string
		...
		GtByteArray::GtByteArray(const std::string & strInput)
			: m_chrNull('\0')
		{
			//call the unicode constructor
			GtByteArray(strInput.c_str(),strInput.size());
		};

		GtByteArray::GtByteArray(const GtByteArray & strInput)
			: m_chrNull('\0')
		{
			//call the unicode constructor
			GtByteArray(strInput.unicode(),strInput.size());
		};

		//!HTL String Destructors
		GtByteArray::~GtByteArray()
		{
		...
		GtByteArray & GtByteArray::operator=(char c)
		{
			//safety check
		...
		GtByteArray & GtByteArray::operator=(const char * ptrRHS)
		{
			//safety check
			if(!m_ptrData){return *this;};
		...
		GtByteArray & GtByteArray::operator=(const unsigned char * ptrRHS)
		{
			//safety check
			if(!m_ptrData){return *this;};
		...
		GtByteArray & GtByteArray::operator=(const std::string & ptrRHS)
		{
			//safety check
			if(!m_ptrData){return *this;};
		...
		GtByteArray & GtByteArray::operator=(const GtByteArray & ptrRHS)
		{
			//safety check
			if(!m_ptrData){return *this;};
		...
		GtByteArray & GtByteArray::operator <<= (char * ptrRHS)
		{
			//safety check
			if(!m_ptrData){return *this;};
		...
		bool GtByteArray::operator == (const char* ptrRHS) const
		{
		...
		bool GtByteArray::operator == (const GtByteArray & ptrRHS) const
		{
			return operator == (ptrRHS.unicode());
		};
		...
		void GtByteArray::reserve(size_t intSize)
		{
			//safety checks
			if(!m_ptrData){return;};
		...
		void GtByteArray::resize(size_t intSize)
		{
			//safety checks
			if(!m_ptrData){return;};
		...
		void GtByteArray::rightTrim(size_t intNumChar)
		{
		...
		void GtByteArray::leftTrim(size_t intNumChar)
		{
			//reallocate aligned with the trim shift
			//safety checks
			if(!m_ptrData){return;};
		...
		void GtByteArray::grow(size_t intSize)
		{
			//safety checks
			if(!m_ptrData){return;};
		...
		void GtByteArray::shrink(size_t intSize)
		{
			//safety checks
			if(!m_ptrData){return;};
		...
		void GtByteArray::realloc()
		{

		};

		//!HTL String Append and Prepend Functions
		GtByteArray & GtByteArray::append(char c)
		{
			//safety checks
			if(!m_ptrData){return *this;};
			if(m_ptrData ==  &m_objSharedNull)
		...
		GtByteArray & GtByteArray::append(const char* ptrRHS)
		{
			//safety checks
			if(!m_ptrData){return *this;};
			if(m_ptrData ==  &m_objSharedNull)
		...
		GtByteArray & GtByteArray::append(const std::string & ptrRHS)
		{	
			//safety checks
			if(!m_ptrData){return *this;};
		...
		GtByteArray & GtByteArray::append(const GtByteArray & ptrRHS)
		{
			//safety checks
			if(!m_ptrData){return *this;};
		...
		GtByteArray & GtByteArray::prepend(char c)
		{
			//safety checks
			if(!m_ptrData){return *this;};
			if(m_ptrData ==  &m_objSharedNull)
		...
		GtByteArray & GtByteArray::prepend(const char* ptrRHS)
		{
			//safety checks
			if(!m_ptrData){return *this;};
			if(m_ptrData ==  &m_objSharedNull)
		...
		GtByteArray & GtByteArray::prepend(const std::string & ptrRHS)
		{
			//safety checks
			if(!m_ptrData){return *this;};
		...
		GtByteArray & GtByteArray::prepend(const GtByteArray & ptrRHS)
		{		
			//safety checks
			if(!m_ptrData){return *this;};
		...
		const char & GtByteArray::at(size_t i) const
		{
		...
		const char & GtByteArray::operator[](size_t i) const
		{
			if(!m_ptrData){ return m_chrNull;};
			if(i < m_ptrData->m_intSize )
			{
		...
		char & GtByteArray::operator[](size_t i)
		{
			if(!m_ptrData){ return m_chrNull;};
			if(i < m_ptrData->m_intSize )
			{
		...
		void GtByteArray::subString(GtByteArray & ptrString, size_t intStart, size_t intLength)
		{	//safety check
			std::string strTemp;
			if(!m_ptrData){return;};
		...
		bool GtByteArray::isEmpty(void) const
		{
			//safety check
			if(!m_ptrData){return true;};
		...
		//
		size_t GtByteArray::capacity(void) const
		{//
			//safety check
			if(!m_ptrData){return 0;};
