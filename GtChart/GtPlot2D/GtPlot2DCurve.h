...
#ifndef GT_PLOT_2DCURVE_H
#define GT_PLOT_2DCURVE_H
...
namespace GT
{
	namespace GtChart
	{
		...
		class HTL_DLLAPI GtPlot2DCurve : public GtPlot2DBase
		{
		public:
			//!Parent set constructor
			GtPlot2DCurve(GtObject* ptrParent = NULL);
			//!Virtual destructor
			virtual ~GtPlot2DCurve(void);
