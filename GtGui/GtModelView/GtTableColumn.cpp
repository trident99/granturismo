...
namespace GT
{
	namespace GtGui
	{
		...
		//default constructor
		GtTableColumn::GtTableColumn(GtObject* ptrParent)
			: GtObject(ptrParent)
		{
			m_strType = "GtTableColumn";
			m_lngColumn = -1;
			m_intWidth = 50;
		};
		//virtual destructor
		GtTableColumn::~GtTableColumn(void)
		{

		};	

		//!Get the cell at column index
		GtTableModelIndex* GtTableColumn::GetCellPtr(int rowIndex)
		{
			size_t i,numCells;
		...
		//!The number of cells
		long GtTableColumn::CountCells(void)
		{
			return m_arrCells.size();
		};
		//!Gather cells from the TableView
		void GtTableColumn::ResetCellMembers(void)
		{
