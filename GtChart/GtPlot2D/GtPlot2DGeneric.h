...
#ifndef GT_PLOT_2DGENERIC_H
#define GT_PLOT_2DGENERIC_H
...
namespace GT
{
	namespace GtChart
	{
		...
		class HTL_DLLAPI GtPlot2DGeneric : public GtPlot2DBase
		{
		public:
			//!Parent set constructor
			GtPlot2DGeneric(GtObject* ptrParent = NULL);
			//!Virtual destructor
			virtual ~GtPlot2DGeneric(void);
