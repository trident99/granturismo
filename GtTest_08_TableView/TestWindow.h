...
#include <GtModelView\GtTableView.h>
...
protected:
	...
	GtTableView * m_tblSprockets;

	HtlUniform m_objRNG;

protected:
	SprocketTableModel* m_ptrSprocketModel;

	Htl2DArray<Sprocket*,HTL_BASE_PTR> m_arrList01;
	Htl2DArray<Sprocket*,HTL_BASE_PTR> m_arrList02;
	Htl2DArray<Sprocket*,HTL_BASE_PTR> m_arrList03;
