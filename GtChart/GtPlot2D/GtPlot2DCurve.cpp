...
namespace GT
{
	namespace GtChart
	{
		...
		GtPlot2DCurve::GtPlot2DCurve(GtObject* ptrParent)
			:GtPlot2DBase(ptrParent)
		{

		};
			//!Virtual destructor
		GtPlot2DCurve::~GtPlot2DCurve(void)
		{
	
		};
		//GTWIDGET INHERITED FUNCTIONS
		//!Custom Event Processing
		int GtPlot2DCurve::HandleEvent(GtEvent * ptrEvent)
		{
			return 0;
		};
		//!Custom Widget Painting
		int GtPlot2DCurve::OnPaint(GtPainter * painter)
		{
			if(!painter){return 0;};
