...
#ifndef GT_SPROCKET_Table_MODEL_H
#define GT_SPROCKET_Table_MODEL_H
...
class SprocketTableModel: public GtTableItemModel
{
public:
	//!Default Constructor
	SprocketTableModel(GtObject* ptrParent = NULL);
	//!Destructor
	virtual ~SprocketTableModel();
	
	//!Set the collection pointer being viewed
	void SetCollectionPtr(Htl2DArray<Sprocket*,HTL_BASE_PTR>*  ptrColl);
	...
	virtual size_t CountColumns(void); 
...
protected:
	...
	Htl2DArray<Sprocket*,HTL_BASE_PTR> * m_ptrCollection;
