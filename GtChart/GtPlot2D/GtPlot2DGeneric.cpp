...
namespace GT
{
	namespace GtChart
	{
		...
		GtPlot2DGeneric::GtPlot2DGeneric(GtObject* ptrParent)
			:GtPlot2DBase(ptrParent)
		{

		};
			//!Virtual destructor
		GtPlot2DGeneric::~GtPlot2DGeneric(void)
		{
	
		};
		//GTWIDGET INHERITED FUNCTIONS
		//!Custom Event Processing
		int GtPlot2DGeneric::HandleEvent(GtEvent * ptrEvent)
		{
			return 0;
		};
		//!Custom Widget Painting
		int GtPlot2DGeneric::OnPaint(GtPainter * painter)
		{
			if(!painter){return 0;};
