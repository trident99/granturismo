...
#ifndef GT_FILE_OPEN_DIALOG_H
#define GT_FILE_OPEN_DIALOG_H
...
namespace GT
{
	namespace GtGui
	{
		...
		class HTL_DLLAPI GtFileOpenDialog : public GtFrame
		{
		public:
			//!Parent set constructor
			GtFileOpenDialog(GtObject* ptrParent = NULL);
			//!Virtual destructor
			virtual ~GtFileOpenDialog(void);
