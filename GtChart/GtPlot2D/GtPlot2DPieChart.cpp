...
namespace GT
{
	namespace GtChart
	{
		...
		GtPlot2DPieChart::GtPlot2DPieChart(GtObject* ptrParent)
			:GtPlot2DBase(ptrParent)
		{

		};
			//!Virtual destructor
		GtPlot2DPieChart::~GtPlot2DPieChart(void)
		{
	
		};
		//GTWIDGET INHERITED FUNCTIONS
		//!Custom Event Processing
		int GtPlot2DPieChart::HandleEvent(GtEvent * ptrEvent)
		{
			return 0;
		};
		//!Custom Widget Painting
		int GtPlot2DPieChart::OnPaint(GtPainter * painter)
		{
			if(!painter){return 0;};
